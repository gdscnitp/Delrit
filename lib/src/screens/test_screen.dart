...
import 'home_screen/components/ride_completed_bottom_sheet.dart';

class TestScreen extends StatelessWidget {
  const TestScreen({Key? key}) : super(key: key);

  void _showModalSheet(BuildContext context, HomeScreenViewModel model) {
      ...
      builder: (builder) {
        return WillPopScope(
          ...
          child: Container(
            ...
            child: rideCompleted(context, model),
          ),
        );
      },
    );
